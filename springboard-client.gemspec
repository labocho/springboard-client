...
Gem::Specification.new do |spec|
  spec.name          = "springboard-client"
  spec.version       = Springboard::Client::VERSION
  spec.authors       = ["labocho"]
  spec.email         = ["labocho@penguinlab.jp"]

  spec.summary       = "springboard server slient"
  spec.description   = "springboard server slient"
  spec.homepage      = "https://github.com/labocho/springboard-client"
  spec.license       = "MIT"
